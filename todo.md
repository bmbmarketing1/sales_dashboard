...
## Edição de Produtos (Título, Código, Categoria) (CONCLUÍDO ✅)

- [x] Criar mutation tRPC para atualizar dados do produto (products.updateInfo)
- [x] Implementar UI de edição na página de detalhes (inline no header)
- [x] Adicionar campos editáveis: título e categoria
- [x] Adicionar botão de editar/salvar/cancelar no header
- [x] Implementar invalidação de cache após salvar
- [x] Testar edição em BL001: título e categoria atualizados com sucesso
